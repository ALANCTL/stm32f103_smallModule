...
#define ADS1246_CS_LOW()  GPIO_ResetBits(GPIOB, GPIO_Pin_10)
#define ADS1246_CS_HIGH()   GPIO_SetBits(GPIOB, GPIO_Pin_10)

#define ADS1246_DRDY_LOW()  GPIO_ResetBits(GPIOB, GPIO_Pin_2)
#define ADS1246_DRDY_HIGH()   GPIO_SetBits(GPIOB, GPIO_Pin_2) 

#define ADS1246_START_LOW()  GPIO_ResetBits(GPIOB, GPIO_Pin_11)
#define ADS1246_START_HIGH()   GPIO_SetBits(GPIOB, GPIO_Pin_11) 

#define ADS1246_RESET_LOW()  GPIO_ResetBits(GPIOA, GPIO_Pin_4)
#define ADS1246_RESET_HIGH()   GPIO_SetBits(GPIOA, GPIO_Pin_4) 

#define ADS1246_DRDY_PIN_STATE() GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_2)
